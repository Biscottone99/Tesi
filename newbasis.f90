...
use module
  ...
  real*8::strenght,hbar,hbarev,echarge,emass,dpg, bubu, balu, delta, gamma, gamma2, tollerance, bibi,norm,temp
...
!=========================LETTURA INPUT=========================
  ...
  do i=1,dim2
     ...
     if((i.ge.(dimm2+1).and.(i.le.dimm2+dimm)))vecconfig(i)=basism(i-dimm2) !zio occhio agli indici che sfori scemo
